...
from core.models.opensora.acceleration.checkpoint import auto_grad_checkpoint
from core.models.opensora.acceleration.communications import gather_forward_split_backward, split_forward_gather_backward
from core.models.opensora.acceleration.parallel_states import get_sequence_parallel_group
from core.models.opensora.blocks import (
    Attention,
    CaptionEmbedder,
...
from core.models.opensora.utils.ckpt_utils import load_checkpoint
...
class STDiT3(nn.Module):
    def __init__(self,  input_size=(None, None, None),
                        input_sq_size=512,
                        in_channels=8,
                        patch_size=(1, 2, 2),
                        hidden_size=1152,
    ...
    def forward(self, x, timestep, y, y_mask=None, x_mask=None, 
                #fps=None, height=None, width=None, 
                **kwargs):
        assert x.ndim == 5
        if x.size(2) == 1:
            fps = 120  # for image
        ...
        if self.skip_y_embedder:
            ...
            y, y_lens = self.encode_text(y, y_mask)
